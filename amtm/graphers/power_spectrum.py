...
for r in range(np.size(month1)):
    ...
    # Produces Monthly Total Plot

    plt.figure(figsize=(10,7))
    plt.scatter(winDays, winTotals, s=100)
    plt.xlim(0,monthrange(int(year), month_to_number(months))[1])
    plt.show()
    ...
    plt.title("Total Power for " + month1[r])
    plt.grid(True)
