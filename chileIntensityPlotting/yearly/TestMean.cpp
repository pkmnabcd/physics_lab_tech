...
TEST(calculateAverages, ComputesUnderNormalConditions)
{
    ...
    OneDay d1 = OneDay(timeData, tempData, 3, "Jan");

    timeData = { 1, 2, 3, 4, 5 };
    tempData = { 3, 6, 1, 0, 2 };
    OneDay d2 = OneDay(timeData, tempData, 3, "Jan");

    timeData = { 1, 2, 3, 4, 5 };
    tempData = { 2, 2, 2, 2, 2 };
    OneDay d3 = OneDay(timeData, tempData, 3, "Jan");

    timeData = { 1, 2, 3, 4, 5 };
    tempData = { 2.0, 2.0, 2.0, 2.0, 2.0 };
    OneDay d4 = OneDay(timeData, tempData, 3, "Jan");
...
TEST(getHourLength, worksFor2009)
{
    ...
    OneDay d1 = OneDay({}, {}, 2, "Jan");
    OneDay d2 = OneDay({}, {}, 100, "Jan");
    OneDay d3 = OneDay({}, {}, 200, "Jan");
    OneDay d4 = OneDay({}, {}, 280, "Jan");
    OneDay d5 = OneDay({}, {}, 281, "Jan");
    OneDay d6 = OneDay({}, {}, 282, "Jan");
    OneDay d7 = OneDay({}, {}, 300, "Jan");
    OneDay d8 = OneDay({}, {}, 318, "Jan");
    OneDay d9 = OneDay({}, {}, 319, "Jan");
    OneDay d10 = OneDay({}, {}, 320, "Jan");
    OneDay d11 = OneDay({}, {}, 363, "Jan");
    OneDay d12 = OneDay({}, {}, 365, "Jan");
    OneDay d13 = OneDay({}, {}, 1, "Jan");
